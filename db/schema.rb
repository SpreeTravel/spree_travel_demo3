...
ActiveRecord::Schema.define(version: 20160822165792) do
  ...
  create_table "spree_context_option_values", force: :cascade do |t|
    t.integer "context_id"
    t.integer "option_value_id"
    t.string  "value"
  end

  create_table "spree_contexts", force: :cascade do |t|
  ...
  create_table "spree_option_types", force: :cascade do |t|
    ...
    t.datetime "created_at",                                     null: false
    t.datetime "updated_at",                                     null: false
    t.string   "attr_type",                default: "selection"
    t.string   "short"
  end
  ...
  create_table "spree_paxes", force: :cascade do |t|
    t.string  "first_name"
    t.string  "last_name"
    t.string  "sex"
    t.date    "birth"
  ...
  create_table "spree_product_type_context_option_types", force: :cascade do |t|
    t.integer "context_option_type_id"
    t.integer "product_type_id"
  end

  create_table "spree_product_type_rate_option_types", force: :cascade do |t|
    t.integer "rate_option_type_id"
    t.integer "product_type_id"
  end

  create_table "spree_product_type_variant_option_types", force: :cascade do |t|
  ...
  create_table "spree_prototypes_taxons", force: :cascade do |t|
    t.integer "taxon_id"
    t.integer "prototype_id"
  end
  ...
  create_table "spree_rates", force: :cascade do |t|
    t.integer  "variant_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_travel_calculators", force: :cascade do |t|
    t.string  "name"
    t.integer "product_type_id"
  end
